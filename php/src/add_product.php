...
<head>
    ...
    <script src="/public/add_product.js" defer></script>
</head>
<body>
    ...
    <div class="main-container">
        <div class="page-header">
            ...
            <p>Isi detail produk yang akan Anda jual.</p>
        </div>
        ...
        <form id="add-product-form" action="/api/add_product_process.php" method="POST" enctype="multipart/form-data">
            <div class="add-product-grid">
                ...
                <div class="product-sidebar">
                    ...
                    <div class="profile-card">
                        ...
                        <div class="form-content">
                            <div class="form-group">
                                <label for="product_image">Foto Utama Produk:</label>
                                <input type="file" id="product_image" name="product_image" required accept="image/jpeg, image/png, image/webp">
